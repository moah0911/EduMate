def show_course_students(course, load_data_func=None, enroll_student_func=None):
    ...
    if load_data_func is None or enroll_student_func is None:
        st.error("Required functions not provided to show_course_students")
        return
        ...
        with st.expander("Add New Students"):
            ...
            if available_students:
                ...
                if st.button("Add Student"):
                    ...
                    success, message = enroll_student_func(course['id'], student_id)
                    if success:
                        st.success(message)
                        st.rerun()
                    else:
